...
type ArticleProp = PropType<{ type: string; list: formatedArticleInfo[] }[]>;
export default defineComponent({
  ...
  setup(props) {
    const { allCateArticles, allTagsMap } = props;
    ...
    const viewCounts = computed(() => {
      let counts = [];
      console.log(111, allCateArticles)
      for (const oneCateInfo of allCateArticles) {
